...
//   render() {
//     const allTeams = fetch('src/content.json');
...
function Title() {
  ...
  <div>
      ...
      <p>This page contains a list of all of the NCAA Basketball Teams.</p>
      <p>Hover over the school to find out more about them.</p>
  </div>
...
class Team extends React.Component<any,any> {
    render() {
      ...
      return (
        <div id="div-box" className="parent">
